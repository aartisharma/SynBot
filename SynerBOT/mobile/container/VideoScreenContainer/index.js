...
const styles = StyleSheet.create({
 ...
 class VideoScreenContainer extends Component {
    ...
    onLoad(event) {
        ...
        if(this.props.speechResults.selectedVideo.videoItem.start_time > 0.0){
        this.player.seek(this.props.speechResults.selectedVideo.videoItem.start_time);
        }
        else{
            this.player.seek(0);
        ...
        return (
            <View style={customStyles.videoWrapper}>
                <Video
                    ...
                    onEnd={this.onEnd}
                    onLoad={this.onLoad}
                    source={{uri :this.props.speechResults.selectedVideo.videoItem.url}}
...
VideoScreenContainer.propTypes = {
...
VideoScreenContainer.defaultProps = {
    videoWidth: 1280,
    videoHeight: 720,
    autoplay: true,
